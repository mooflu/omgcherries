...
class ImageOnlySelectable : public Selectable {
public:
    ImageOnlySelectable(bool enabled, const BoundingBox& r, const std::string& text, const std::string& info,
                        bool center = true, float size = 1.0, float red = 1.0, float green = 1.0, float blue = 1.0);
...
private:
    ImageOnlySelectable(const ImageOnlySelectable&);
    ImageOnlySelectable& operator=(const ImageOnlySelectable&);
};
...
public:
    ActionSelectable(bool enabled, const BoundingBox& r, const std::string& action, const std::string& text,
                     const std::string& info, float size = 1.0);
